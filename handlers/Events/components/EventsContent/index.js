        ...
        <ol className="EventsContent-list">
          {events.length > 0 ? events.map(e => (
            <li key={e.event_url} className="EventsContent-item">
              ...
              <Button className="EventsContent-button" type="secondary" href={e.event_url} target="_blank" style={{color: '#393939', backgroundColor: '#fff', textTransform: 'none', border: '1px solid #efefef', borderRadius: '0'}}>View More Details & RSVP</Button>
            </li>
          )) : (
