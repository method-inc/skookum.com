  ...
  render(): ReactElement {
    ...
    return (
      <form
        ...
        <Input required handleChange={this.handleChange} label="What’s your name? *" name="firstname" />
        <Input required handleChange={this.handleChange} label="And how about your email? *" name="email" type="email" />
        <Input handleChange={this.handleChange} label="Who do you work for?" name="company" />
        <Input handleChange={this.handleChange} label="Phone numbers are optional" name="phone" type="phone"/>
        <Input required handleChange={this.handleChange} element="textarea" label="Submit your message here *" name="how_can_we_help_you_" />
        <Input handleChange={this.handleChange} label="How did you hear about us?" name="how_did_you_hear_about_us_" />
