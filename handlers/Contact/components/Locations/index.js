...
var renderSegment: ReactElement = (segment: Location) => (
  <TabPanel key={segment.name}>
    <div className="ContactLocations-background" style={{backgroundImage: `url(/public/images/home-${segment.name.toLowerCase()}.png)`}}>
      <div className="ContactLocations-overlay"></div>
